			...
			MongoClient.connect('mongodb://mcse:mcsew@10.65.164.37:27017/mcse-trace', function(err, db) {
			   ...
			   var collection = db.collection('triplet_7_4').find({"createdAt": {$gt: new Date('2017-04-07T05:00:00.00-07:00'), $lt: new Date('2017-04-07T05:10:59.59-07:00')}});
			   collection.each(function(err, doc){
	               if(!err && doc!=null && doc != undefined){
			   	      ...
			   	      if(count % 300 ==0){
			   	   	     ...
			   	   	     sleep.sleep(3);
			   	   	     setTimeout(callBackFunc1(doc ,db),3000);
			   	      }else{
